...
<head>
  ...
  <title>Halaman Utama - Sally Laundry</title>
...
@include('layout.header') 
  ...
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    <div class="row align-items-center mb-5">
      ...
      <div class="col-lg-6">
        <div class="hero-image text-center">
          <img src="asset/atas1.png" alt="Business Growth" class="img-fluid" loading="lazy" style="max-height: 300px; max-width: 300px;">
          <img src="asset/atas2.png" alt="Business Growth" class="img-fluid" loading="lazy" style="max-height: 300px; max-width: 300px;">
        </div>
      </div>
    </div>
  </div>
    ...
    <section id="about" class="call-to-action-2 section light-background" style="text-color:rgb(255, 255, 255); background-color:rgb(255, 255, 255); ">
        ...
        <div class="row g-5 align-items-center">
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="cta-content">
              ...
              <p class="lead">Sally Laundry adalah adalah layanan laundry kiloan dan satuan. Kami adalah tim profesional yang selalu mengutamakan kualitas cucian & pelayanan dengan prinsip bersih, rapi, wangi, dan tepat waktu.</p>
              <p class="lead">Sally Laundry menerima laundry kiloan untuk perusahaan, misal kantor, rumah sakit, asrama, pesantren, sekolah, perusahaan konveksi atau perusahaan-perusahaan semisal. silakan hubungi kami untuk penawaran harga khususnya.</p>
  ...
  <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-graphics">
    <div class="portfolio-card" style="text-color:rgb(255, 255, 255); background-color: #e6698f; ">
      <div class="portfolio">
      <div class="text-center">
        <img src="asset/cuci_setrika.png" class="img-fluid" alt="" loading="lazy" style="max-height: 300px;">
</div>
        <div class="portfolio-overlay">
          <div class="portfolio-actions">
